...
public class DeviceActions {
    ...
    static void sendWhatsApp(Context c, String target, String text, Result r) {
        try {
            ...
            try {
                ...
                r.onResult(true, "WhatsApp opened for " + target);
            } catch (Exception e) {
    ...
    static void waCall(Context c, String target, boolean video, Result r) {
        try {
            ...
            i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            c.startActivity(i);
            r.onResult(true, "WhatsApp opened. Tap the call button Boss — auto-call isn't supported by WhatsApp.");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    static String mapApp(String n) {
        switch (n) {
            ...
            case "maps": case "googlemaps": return "com.google.android.apps.maps";
            ...
            case "messages": case "sms": return "com.android.mms";
            case "clock": case "alarm": return "com.android.deskclock";
            case "calendar": return "com.android.calendar";
            case "files": case "filemanager": return "com.android.documentsui";
            case "playstore": case "store": return "com.android.vending";
